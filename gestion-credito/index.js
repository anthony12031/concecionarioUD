...
router.get('/cotizacionesCredito/cliente/:cedula',function(req,res){
	...
	console.log(cedula);
	sql = "SELECT C.idcotizacion cotizacion, C.cedula,C.total  FROM cotizacion C, proceso P WHERE C.idCotizacion = P.idcotizacion AND P.idTipoProceso = 2 AND C.cedula= "+cedula;
	dao.open(sql,[],false,res);
})
